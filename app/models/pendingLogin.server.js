...
pendingLoginSchema.index({ expiresAt: 1 }, { expireAfterSeconds: 3600 });

// Hash OTP before saving
pendingLoginSchema.pre("save", async function (next) {
...
pendingLoginSchema.pre("findOneAndUpdate", async function (next) {
