...
export default function AddRotaModal({ employeeList = [], assignedToList = [], defaultDate, serverError, onClose, onSuccess }) {
  ...
  const handleSubmit = (e) => {
    ...
    fetcher.submit(payload, { method: "post", action: "/rota" });
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-auto">
        ...
        <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-gray-100">
          <h2 className="text-lg font-bold text-gray-900">Add Rota</h2>
          <button
            onClick={onClose}
